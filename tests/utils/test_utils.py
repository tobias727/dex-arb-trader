...
class TestUtils:
    ...
    def test_calculate_pnl_cex_buy_dex_sell(self):
            ...
            "logs": [
                {
                    ...
                    "data": HexBytes(
                        "0x00000000000000000000000000000000000000000000000000000000007c5b04"
                    ),
                }
            ],
            "gasUsed": 100_000,
        ...
        commission = Decimal("0.00000190") * Decimal(
            "4078.76"
        )  # ETH fee converted to USDC at price
        gas_fee_usdc = (
            Decimal("100000") * Decimal("100000") / Decimal("1e18") * Decimal("4078.76")
        )  # gas in ETH * price in USDC
        expected_pnl = round((usdc_out - buy_cost - commission - gas_fee_usdc), 6)
    ...
    def test_calculate_pnl_cex_sell_dex_buy(self):
        ...
        gas_fee_usdc = (
            Decimal("100000") * Decimal("100000") / Decimal("1e18") * Decimal("4200")
        )
